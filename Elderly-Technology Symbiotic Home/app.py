...
# 11 on
def turn_11_on():
    url = os.getenv("TURN_11_ON_URL")
    auth_token = os.getenv("TURN_11_ON_AUTH_TOKEN")
...
# 11 off
def turn_11_off():
    url = os.getenv("TURN_11_OFF_URL")
    auth_token = os.getenv("TURN_11_OFF_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 12 on
def turn_12_on():
    url = os.getenv("TURN_12_ON_URL")
    auth_token = os.getenv("TURN_12_ON_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 12 off
def turn_12_off():
    url = os.getenv("TURN_12_OFF_URL")
    auth_token = os.getenv("TURN_12_OFF_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 13 on
def turn_13_on():
    url = os.getenv("TURN_13_ON_URL")
    auth_token = os.getenv("TURN_13_ON_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 13 off
def turn_13_off():
    url = os.getenv("TURN_13_OFF_URL")
    auth_token = os.getenv("TURN_13_OFF_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 14 on
def turn_14_on():
    url = os.getenv("TURN_14_ON_URL")
    auth_token = os.getenv("TURN_14_ON_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 14 off
def turn_14_off():
    url = os.getenv("TURN_14_OFF_URL")
    auth_token = os.getenv("TURN_14_OFF_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 15 on
def turn_15_on():
    url = os.getenv("TURN_15_ON_URL")
    auth_token = os.getenv("TURN_15_ON_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 15 off
def turn_15_off():
    url = os.getenv("TURN_15_OFF_URL")
    auth_token = os.getenv("TURN_15_OFF_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 16 on
def turn_16_on():
    url = os.getenv("TURN_16_ON_URL")
    auth_token = os.getenv("TURN_16_ON_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
# 16 off
def turn_16_off():
    url = os.getenv("TURN_16_OFF_URL")
    auth_token = os.getenv("TURN_16_OFF_AUTH_TOKEN")
    headers = {'Authorization': auth_token}
    response = requests.post(url, headers=headers)
    return response.text
...
def storeFallData():
    ...
    service_account_key_path = os.getenv("CREDENTIALS_FILE")
...
SPEECH_AUTHORIZATION_TOKEN = os.getenv("SPEECH_AUTHORIZATION_TOKEN")
SPEECH_HEADERS = {"Authorization": SPEECH_AUTHORIZATION_TOKEN}

TTS_API_URL = os.getenv("TTS_API_URL")
TTS_AUTHORIZATION_TOKEN = os.getenv("TTS_AUTHORIZATION_TOKEN")
TTS_HEADERS = {"Authorization": TTS_AUTHORIZATION_TOKEN}
